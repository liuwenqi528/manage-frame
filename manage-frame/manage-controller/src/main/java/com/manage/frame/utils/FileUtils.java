...
public class FileUtils {
    ...
    public static final String UPLOAD_PATH = "e://file/manage/";
    ...
    //    上传
    public static void fileUpload(MultipartFile file, String path) throws Exception {
        ...
        if (file != null) {
            ...
            //拼接附件存储的地址/
            String filePath = UPLOAD_PATH + path + date +  fileNewName + fileType;
